...
import { Activity, Brain, Zap, TrendingUp, Radar, BarChart3 } from "lucide-react";
  ...
  const handleCapture = useCallback(async (imageBase64: string) => {
    ...
    try {
      ...
      if (data?.emotions) {
        ...
        setHistory((prev) => [
          ...prev.slice(-29), // Keep last 30 snapshots
        ...
        <div className="grid lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <motion.div
              ...
              animate={{
                borderColor: result.dominant !== "none" ? "hsl(180, 100%, 50%, 0.3)" : "hsl(220, 15%, 18%)",
              }}
            >
              ...
              >
                ...
                {activeTab === "timeline" && (
                  <div className="rounded-lg border border-border bg-card p-5">
                    ...
                    <EmotionTimeline
                      history={history}
                      visibleEmotions={["happy", "sad", "angry", "surprised", "neutral", "excited"]}
                    />
                  </div>
                )}
              </motion.div>
